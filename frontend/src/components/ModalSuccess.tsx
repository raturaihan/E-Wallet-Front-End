            ...
            <div className="modal-dialog">
                ...
                <div className="modal-body">
                    <div className='container'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="currentcolor" className="bi bi-check-circle-fill text-success" viewBox="0 0 16 16">
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                        </svg>
                        </div>
                        <div className='row mt-3'>
                        <div className='d-flex justify-content-center'>
                            <h1 className='fw-bold text-success'>{typeTrans} Success</h1>
                        </div>
                        </div>
                        <div className='row mt-5'>
                            <div className='d-flex justify-content-between align-items-center'>
                                <p>Amount</p>
                                <p className='fw-bold fs-3'>{amount}</p>
                            </div>
                        </div>
                        <div className='row'>
